...
import LeftSider from "~/components/pages/index/LeftSider";
import RightSider from "~/components/pages/index/RightSider";
import { RightSiderProps } from "~/components/pages/index/RightSider";
